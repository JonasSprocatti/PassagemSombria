...
export const IMPLANTES = [
 ...
 {n:"Tradutor Universal Subcortical",p:600,e:"+2 Persuasão, tradução em tempo real",g:"Cabeça"},
...
export const PERICIAS = [["Acrobacia","Des"],["Armas Brancas","For"],["Armas de Fogo","Des"],["Resistência / Fortitude","Con"],["Espionagem / Disfarce","Int"],["Furtividade","Des"],["Investigação","Int"],["Sobrevivência","Sab"],["Conhecimentos Gerais","Int"],["Explosivos","Int"],["Mecânica","Int"],["Medicina / Alquimia","Int"],["Pilotagem","Des"],["Tecnomancia","Int"],["Intimidação","Car"],["Liderança","Car"],["Performance / Arte","Car"],["Persuasão","Car"]];
...
export const ESTACOES = {
 ...
 sensores:{n:"Sensores (Tático)",acoes:[
  ...
  {n:"Rastreio de Fraqueza",rola:["Sab","Investigação"],d:"Sucesso: o próximo acerto da nave aliada causa +1d6."}]},
};
