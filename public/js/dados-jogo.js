...
export const RACAS = [
 ...
 },
 {
  ...
  "habilidades": [
   ...
   ,
    "opcoes": [
     { "n": "Oxigénio", "ic": "🕊", "d": "Cria asas temporárias: ganha Deslocamento de voo igual ao de caminhada.",
       "efeitos": [{ "tipo": "imunidade", "a": "terreno difícil (voando)" }] },
     { "n": "Hélio", "ic": "🎈", "d": "Flutuabilidade: imune a dano de queda e move-se livremente no vácuo.",
       "efeitos": [{ "tipo": "imunidade", "a": "dano de queda" }] },
     { "n": "Hidrogênio", "ic": "💪", "d": "Aumenta de tamanho: +2 em testes de Força, mas o movimento cai pela metade.",
       "efeitos": [{ "tipo": "atributo", "attr": "For", "valor": 2 }, { "tipo": "deslocamento", "valor": -4 }] },
  ...
  "habilidades": [
   {
    ...
    "d": "O terráqueo é uma tela em branco. Ao criar o personagem, o jogador recebe +4 pontos para distribuir livremente entre quaisquer Atributos (For, Des, Con, Int, Sab, Car), no máximo +2 em cada, e +3 pontos para distribuir em Perícias. São os mesmos +4 que toda outra raça recebe em bônus fixos — a diferença é que o terráqueo escolhe onde."
   ,
    "tipo": "Passiva",
    "freq": "passiva"
   },
   ...
   {
    "n": "Resiliência Terráquea",
    "d": "A biologia terráquea é frágil aos olhos do universo, mas aguenta o que nenhuma outra aguenta: +3 Pontos de Vida máximos."
   ,
    "tipo": "Passiva",
    "freq": "passiva",
    "efeitos": [{"tipo":"pv_max","valor":3}]
   }
  ],
  "lendaria": {
 ...
 },
 {
  ...
  "habilidades": [
   {
    "n": "Física de Motor",
    "d": "Devido à densidade de seus corpos, eles recebem +1 de bônus permanente na Classe de Defesa (CD). Narrativamente, também carregam bem mais peso do que o esperado para o seu tamanho (a critério do Mestre — o jogo não rastreia peso de inventário)."
   ,
    "tipo": "Passiva",
    "freq": "passiva",
    "efeitos": [{"tipo":"defesa","valor":1}]
   },
   {
    "n": "Engenharia de Bordo",
    "d": "Recebem um bônus permanente de +1 nas perícias Pilotagem e Mecânica."
   ,
    "tipo": "Passiva",
    "freq": "passiva",
    "efeitos": [{"tipo":"pericia","pericia":"Pilotagem","valor":1},{"tipo":"pericia","pericia":"Mecânica","valor":1}]
   },
   {
 ...
 },
 {
  ...
  "lendaria": {
   ...
   "resolve": { "tipo": "salvaguarda", "atributo": "Con", "dado": "4d8", "cond": "Paralisado", "turnos": 1, "area": true, "raio": 15, "tipoDano": "gélido" }
  }
 },
 {
  "nome": "Proturno",
 ...
 },
 {
  ...
  "habilidades": [
   ...
   },
   {
    ...
    "d": "Se ouvirem alguém dizer que Plutão não é um planeta durante uma batalha, entram em fúria instintiva. Crescem de tamanho, ganham +2 de Força e Constituição e +2 nas rolagens de ataque e dano, mas perdem a capacidade de distinguir aliados de inimigos por 4 turnos."
   ,
    "tipo": "Ativa",
    "freq": "curto"
   ,acao:"Reação",duracao:{base:4},resolve:{tipo:"modo",aviso:"Não distingue aliados de inimigos!",efeitos:[{tipo:"atributo",attr:"For",valor:2},{tipo:"atributo",attr:"Con",valor:2},{tipo:"acerto",valor:2,momento:"ao_atacar"},{tipo:"dano",valor:2,momento:"ao_atacar"}]}}
  ],
  "lendaria": {
   "n": "Colosso do Vácuo",
...
export const CLASSES = {
 "Estudioso":{pv:4,titulo:"O Cofre de Conhecimento Interligado",lore:"Para o Estudioso, a galáxia não é um mistério assustador, mas sim um imenso banco de dados aguardando para ser indexado. Eles são arqueólogos do espaço, cientistas forenses e pesquisadores; a mente de um Estudioso funciona de forma não-linear, como uma imensa rede de notas interligadas — quando olham para uma arma alienígena, não veem apenas o metal, cruzam referências mentais de história, química e metalurgia em frações de segundo para entender como aquilo funciona e como pode ser desmontado. Em grupo, é o resolvedor de quebra-cabeças e o perito em descobrir os pontos fracos dos inimigos: em combate, não atira mais rápido, atira no lugar exato onde a armadura do inimigo está gasta.",equipamento:"Roupas Civis (CD +0). Pistola de Pulso EMP (1d4, Anti-Sintético) ou Pistola Laser Compacta (1d6). Datapad de Pesquisa Avançado e 1 Bateria Fantasma de emergência (recupera 1 Slot de RAM).",pericias:{"História / Cultura":4,"Investigação":3,"Mecânica":2,"Tecnomancia":2,"Lábia / Persuasão":1},hab:[{n:"Mapa Mental",tipo:"Ativa",freq:"sessao",d:"1x/sessão: declara já ter lido sobre um assunto/criatura/facção. O Mestre fornece uma informação útil, tática ou uma fraqueza.",resolve:{tipo:"consulta",pergunta:"Sobre o que você já leu?"}},{n:"Ponto Estrutural Crítico",tipo:"Ativa",freq:"livre",ram:1,acao:"Ação Principal",d:"Ação Principal (1 RAM): analisa um inimigo. O próximo ataque contra ele causa dano máximo, sem rolar.",resolve:{tipo:"marcar",cond:"Ponto Fraco",turnos:99,cargas:1}}],vet:{n:"Análise em Cascata",tipo:"Passiva",freq:"combate",d:"1x/combate: Ponto Estrutural sem gastar RAM. Fraquezas catalogadas: +1 de dano do grupo contra o tipo.",efeitos:[{tipo:"gratis_por_combate",hab:"Ponto Estrutural Crítico"},{tipo:"catalogar"}]},
  lendaria:{n:"Teorema do Colapso",freq:"longo",acao:"Ação Principal",d:"Ação Principal, 1x/desc. longo: o Estudioso enxerga a falha estrutural de tudo num raio de 6 m e a diz em voz alta. Inimigos na área testam Inteligência ou sofrem 5d8 e ficam Enfraquecidos por 2 turnos.",resolve:{tipo:"salvaguarda",atributo:"Int",dado:"5d8",cond:"Enfraquecido",turnos:2,area:true,raio:6}}},
 "Mecânico":{pv:6,titulo:"O Arquiteto da Sobrevivência Metálica",lore:"Enquanto soldados confiam no poder do gatilho e diplomatas na força das palavras, o Mecânico confia na graxa, nos blueprints e no torque — enxerga naves e equipamentos como organismos vivos que precisam de cuidado, sangue (óleo) e cirurgias (soldas). Num veículo, não é apenas mais um tripulante: é o médico da embarcação. Com ferramentas nas mãos, transforma destroços bélicos em defesas intransponíveis e mantém os escudos erguidos quando tudo ao redor está desmoronando — o suporte defensivo do grupo, mestre do controle de área e salvador oficial durante o Combate Espacial.",equipamento:"Traje de Bordo Atmosférico (CD +2, imune ao vácuo). Revólver de Íons Pesado (1d8) ou Escopeta Sônica (2d6). Garras de Combate (1d4). Caixa de Ferramentas Mecânicas e um rolo de Fita Isolante Espacial.",pericias:{"Mecânica":5,"Pilotagem":2,"Armas Brancas":2,"Tecnomancia":1,"Lábia / Persuasão":1,"Sobrevivência":1},hab:[{n:"Operador de Máquinas Pesadas",tipo:"Passiva",freq:"passiva",d:"Ignora penalidades de movimento e acrobacia de Armaduras Pesadas.",efeitos:[{tipo:"imunidade",a:"penalidades de Armaduras Pesadas"}]},{n:"Reparo Tático",tipo:"Ativa",freq:"livre",d:"Ação Principal: aliado ou nave ganha 1d6 + Mecânica de PV Temporários até o fim da batalha.",acao:"Ação Principal",resolve:{tipo:"pvtemp",dado:"1d6",pericia:"Mecânica",nave:true}}],vet:{n:"Torreta de Sucata",freq:"combate",acao:"Ação Principal",d:"1x/combate: torreta (10 PV, CD 12) que atira 1d6 a 15m no início de cada turno seu.",resolve:{tipo:"invocar_aliado",nome:"Torreta de Sucata",hp:10,cd:12,dano:"1d6",alcance:15,pericia:"Mecânica",attr:"Int"}},
  lendaria:{n:"Blindagem de Campo",freq:"longo",acao:"Ação Principal",d:"Ação Principal, 1x/desc. longo: o Mecânico solda placas, desvia energia e improvisa um casco em cima de alguém. O alvo ganha 3d10 + Mecânica de PV Temporários até o fim da batalha.",resolve:{tipo:"pvtemp",dado:"3d10",pericia:"Mecânica"}}},
 "Assassino":{pv:8,titulo:"A Sombra Fria e a Lâmina Silenciosa",lore:"Não são meros capangas: são fantasmas que operam nas entrelinhas da sociedade. Um Assassino estuda a anatomia de incontáveis raças alienígenas para saber exatamente onde a faca deve entrar para evitar o osso e perfurar o coração, e vive em constante furtividade, treinando a respiração e os batimentos cardíacos para se tornar indetectável aos sensores térmicos e sonoros de estações de segurança. Quando a negociação falha e o combate frontal é suicídio, resolve o problema antes que o inimigo saiba que a batalha começou — dano explosivo massivo, infiltração profunda e eliminação de alvos de alto valor (comandantes, tecnomantes inimigos) antes que o combate geral estoure.",equipamento:"Traje Furtivo de Nanofibra (CD +1, +2 em Furtividade). Besta Magnética Phobos (1d8, Silenciosa) ou Submetralhadora de Flechetes (2d4, Sangramento). Faca de Plasma (1d4, Oculta) e 1 Granada de Fumaça.",pericias:{"Furtividade":4,"Armas Brancas":2,"Armas de Fogo":2,"Enganação":2,"Medicina":1,"Lábia / Persuasão":1},hab:[{n:"O Primeiro Corte",tipo:"Passiva",freq:"passiva",d:"Contra inimigo que ainda não agiu ou não o notou: +2 no acerto e dano da arma DOBRADO.",efeitos:[{tipo:"acerto",valor:2,quando:"desprevenido",momento:"ao_atacar"},{tipo:"multiplicar_dano",fator:2,quando:"desprevenido",momento:"ao_atacar"}]},{n:"Desaparecer nas Sombras",tipo:"Ativa",freq:"livre",acao:"Ação Livre",d:"Ao derrubar um inimigo: Ação Livre para rolar Furtividade e sumir do campo de visão.",resolve:{tipo:"esconder",pericia:"Furtividade",requerAbate:true}}],vet:{n:"Anatomia Comparada",tipo:"Passiva",freq:"combate",d:"Furtivos critam com 19–20; Desaparecer 1x/combate mesmo sem abate.",efeitos:[{tipo:"critico_em",valor:19,quando:"desprevenido"},{tipo:"gratis_por_combate",hab:"Desaparecer nas Sombras"}]},
  lendaria:{n:"Nome na Lista",freq:"longo",acao:"Ação Livre",d:"Ação Livre, 1x/desc. longo: o Assassino escreve um nome. Até esse alvo cair, TODO ataque dele contra essa pessoa conta como Ataque Furtivo — mesmo que ela esteja alerta, de frente e esperando o golpe.",resolve:{tipo:"marcar",cond:"Na Lista",turnos:99}}},
 "Soldado":{pv:10,titulo:"O Baluarte de Fogo e Aço",lore:"Enquanto as outras classes debatem táticas complexas, o Soldado limpa a sala. São os veteranos de mil zonas de guerra, fuzileiros navais espaciais ou mercenários experientes, que não confiam na sorte ou em scripts imprevisíveis — confiam no recuo de uma escopeta sónica e no fio de uma espada térmica. A mente de um Soldado avalia o campo de batalha em termos de cobertura, linhas de visão e zonas de estrangulamento.",equipamento:"Colete Tático Padrão (CD +2). Rifle de Assalto Híbrido (1d8, Rajada) ou Escopeta Sônica (2d6). Faca de Plasma (1d4). 1 Kit Médico de Batalha (cura 1d8 PV).",pericias:{"Armas de Fogo":4,"Armas Brancas":3,"Explosivos":2,"Pilotagem":1,"Sobrevivência":1,"Furtividade":1},hab:[{n:"Memória Muscular",tipo:"Passiva",freq:"passiva",d:"Não sofre a penalidade de −2 com armas Pesadas.",efeitos:[{tipo:"imunidade",a:"penalidade de -2 com armas Pesadas"}]},{n:"Fogo de Supressão",tipo:"Ativa",freq:"livre",acao:"Ação Principal",d:"Ação Principal: alvo testa Sabedoria; falhou → acovardado e ataca com Desvantagem. (NV5: cone de 5m.)",resolve:{tipo:"salvaguarda",atributo:"Sab",cond:"Acovardado",turnos:2}}],vet:{n:"Rajada Disciplinada",freq:"combate",acao:"Ação Livre",duracao:{base:1},d:"1x/combate: dois ataques com a mesma arma na Ação Principal. E o Fogo de Supressão passa a pegar todos num cone de 5 m.",efeitos:[{tipo:"area_de",hab:"Fogo de Supressão",raio:5}],resolve:{tipo:"modo",efeitos:[{tipo:"ataque_extra",valor:1}]}},
  lendaria:{n:"Não Recuar",freq:"longo",acao:"Ação Livre",duracao:{base:4},d:"Ação Livre, 1x/desc. longo: o Soldado planta os pés e decide que esta sala é dele. Por 4 turnos, sofre 3 de dano a menos de cada golpe e cada Ação Principal permite dois ataques com a mesma arma.",resolve:{tipo:"modo",efeitos:[{tipo:"reducao_dano",valor:3,momento:"ao_sofrer"},{tipo:"ataque_extra",valor:1}]}}},
 "Starlord":{pv:8,titulo:"A Voz de Comando e a Sorte Audaz",lore:"Metade comandante, metade malandro: o Starlord é a cola que mantém a tripulação unida. Não atira tão bem quanto o Soldado nem pirateia sistemas tão bem quanto o Cinético, mas a sua verdadeira força é inspirar a equipa a fazer o impossível e negociar a saída de qualquer buraco negro político — governa o espaço entre as estrelas através da lábia, da presença de espírito e de uma audácia que beira a insanidade.",equipamento:"Roupas Civis Elegantes (CD +0). Pistola Laser Compacta (1d6). Faca de Plasma (1d4). Módulo de Som Portátil e uma garrafa de bebida contrabandista de alta qualidade.",pericias:{"Lábia / Persuasão":5,"Armas de Fogo":2,"Tecnomancia":2,"Pilotagem":2,"Furtividade":1},hab:[{n:"Charme Malandro",tipo:"Ativa",freq:"sessao",d:"1x/encontro social (1x/sessão na mesa): re-rola um teste de Lábia / Persuasão falhado, com uma desculpa rápida ou uma ameaça sutil.",resolve:{tipo:"teste",pericia:"Lábia / Persuasão",rot:"re-rolagem"}},{n:"\u201cDeixem isto comigo!\u201d",tipo:"Ativa",freq:"livre",acao:"Ação Livre",d:"Ação Livre: o próximo aliado a atacar ganha Vantagem. (NV5: os dois próximos.)",resolve:{tipo:"inspirar",cargas:1}}],vet:{n:"Palavra de Capitão",freq:"longo",d:"1x/desc. longo: cede o turno para dar um turno completo extra a um aliado. E “Deixem isto comigo!” passa a valer para os dois próximos aliados.",efeitos:[{tipo:"cargas_de",hab:"“Deixem isto comigo!”",valor:2}],resolve:{tipo:"turno_extra",alvos:"um",cede:true}},
  lendaria:{n:"É Agora ou Nunca",freq:"longo",acao:"Ação Livre",d:"Ação Livre, 1x/desc. longo: o Starlord diz a frase que a tripulação vai repetir em tabernas pelos próximos dez anos. TODOS os aliados em cena ganham imediatamente um turno completo extra, na ordem que eles mesmos escolherem.",resolve:{tipo:"turno_extra",alvos:"todos"}}},
 "Franco-atirador":{pv:6,titulo:"O Observador Letal",lore:"A paciência é a arma mais destrutiva do universo, e o Franco-atirador controla a geometria da morte. Posicionado em coberturas elevadas ou nas sombras de uma cratera de asteroide, controla o fluxo do combate muito antes de a primeira gota de sangue ser derramada — conhece a velocidade do vento, a gravidade local e o ponto de falha no capacete de um Legionário marciano.",equipamento:"Colete Tático Padrão (CD +2). Rifle de Precisão Magnético (1d12, Telescópica). Bastão de Choque (1d6, Atordoante). Binóculos Termais.",pericias:{"Armas de Fogo":5,"Sobrevivência":3,"Furtividade":2,"Investigação":2},hab:[{n:"Foco à Distância",tipo:"Ativa",freq:"livre",acao:"Ação Principal",d:"Analisa 1 turno; no próximo, acerto E dano com Vantagem. (NV5: Ação de Movimento.)",resolve:{tipo:"marcar",cond:"Em Foco",turnos:99,cargas:1}},{n:"Tiro Incapacitante",tipo:"Passiva",freq:"livre",d:"Mira num membro: metade do dano, alvo com deslocamento 0 (ou derruba a arma) por 1 turno.",efeitos:[{tipo:"opcao_ataque",id:"incapacitante",rot:"🦵 Incapacitante",d:"Mira num membro: metade do dano, e o alvo fica Lento (deslocamento zero) por 1 turno.",multDano:0.5,cond:"Lento",turnos:1}]}],vet:{n:"Geometria da Morte",freq:"combate",acao:"Ação Livre",d:"Foco à Distância vira Ação de Movimento. E 1x/combate: o próximo disparo ignora completamente qualquer cobertura.",efeitos:[{tipo:"acao_de",hab:"Foco à Distância",acao:"Ação de Movimento"}],resolve:{tipo:"modo",efeitos:[{tipo:"disparo_sem_cobertura"}]}},
  lendaria:{n:"Um Tiro",freq:"longo",acao:"Ação Livre",d:"Ação Livre, 1x/desc. longo: o Franco-atirador para de respirar e o universo coopera. O PRÓXIMO disparo com arma de fogo ignora cobertura, alcance e Defesa — acerta automaticamente, sem rolagem, e causa o dano MÁXIMO da arma, dobrado.",resolve:{tipo:"modo",efeitos:[{tipo:"tiro_perfeito"}]}}},
 "Músico":{pv:4,titulo:"O Arquiteto de Frequências",lore:"No espaço, o som não se propaga no vácuo, mas nas naves e estações espaciais a música dita o ritmo da sociedade. Os músicos não são apenas artistas: são hackers da psicologia e da tecnologia, e usando instrumentos digitais que codificam algoritmos em frequências sonoras, conseguem interferir com implantes inimigos ou induzir estados de transe nos aliados. Muitos formam guildas de contadores de histórias e difusores de notícias — a mais famosa no submundo é o Conclave do Papelão, um grupo influente que transmite mensagens e dados confidenciais através de frequências piratas em toda a galáxia.",equipamento:"Roupas Civis (CD +0). Pistola Laser Compacta (1d6). Instrumento Musical Digital (funciona como Deck de Tecnomancia) e 1 Bateria Fantasma (recupera 1 RAM).",pericias:{"Tecnomancia":5,"Performance / Arte":4,"Lábia / Persuasão":2,"Armas Brancas":1},hab:[{n:"Ouvido Absoluto",tipo:"Passiva",freq:"passiva",d:"+1 na CD (resistência a controle mental, ilusões e dano sônico).",efeitos:[{tipo:"defesa",valor:1}]},{n:"Frequência de Inspiração/Ressonância",tipo:"Ativa",freq:"livre",acao:"Ação Principal",d:"Aura 10m: aliados +2 acerto OU inimigos −2 CD. Dura enquanto não sofrer dano (NV5: Performance CD12 sustenta).",resolve:{tipo:"modo",quebraAoSofrer:true,opcoes:[{n:"Inspiração",d:"aliados a 10 m: +2 no acerto",efeitos:[{tipo:"aura",alvo:"aliados",acerto:2,raio:10}]},{n:"Ressonância",d:"inimigos a 10 m: −2 na Defesa",efeitos:[{tipo:"aura",alvo:"inimigos",defesa:-2,raio:10}]}]}}],vet:{n:"Maestro de Guerra — Acorde Duplo",freq:"combate",acao:"Ação Principal",duracao:{base:2},d:"A Frequência não cai mais sozinha ao sofrer dano: Performance CD 12 a mantém. E 1x/combate, o Acorde Duplo: os DOIS efeitos simultâneos por 2 turnos.",efeitos:[{tipo:"sustenta_aura",pericia:"Performance / Arte",cd:12}],resolve:{tipo:"modo",efeitos:[{tipo:"aura",alvo:"aliados",acerto:2,raio:10},{tipo:"aura",alvo:"inimigos",defesa:-2,raio:10}]}},
  lendaria:{n:"Sinfonia Total",tipo:"Passiva",freq:"passiva",d:"A Frequência deixa de ser uma escolha: alcança 20 m, aplica os DOIS efeitos ao mesmo tempo (aliados +2 no acerto E inimigos −2 na CD) e não é mais interrompida por dano. O Músico só para de tocar quando cai.",efeitos:[{tipo:"aura",alvo:"aliados",acerto:2,raio:20},{tipo:"aura",alvo:"inimigos",defesa:-2,raio:20},{tipo:"aura_inquebravel"}]}},
 "Espião":{pv:4,titulo:"O Fantasma de Mil Rostos",lore:"A guerra não se vence apenas com armas pesadas, mas com a informação certa sussurrada no ouvido certo. O Espião é o mestre da engenharia social e da infiltração — não se esconde nas sombras como os Assassinos, esconde-se à vista de todos, vestindo a farda do inimigo, forjando credenciais e imitando sotaques. Consegue entrar num cofre de segurança máxima de Deimos apenas com uma prancheta na mão e a atitude inabalável de que \"pertence àquele lugar\": infiltração social, extração de informações sem disparar alarmes e manipulação de NPCs.",equipamento:"Roupas Civis (CD +0). Pistola Laser Compacta (1d6). Faca de Plasma (1d4, Oculta). Um kit com 2 Identidades Falsas credenciadas da Confederação e credenciais corporativas.",pericias:{"Enganação":4,"Lábia / Persuasão":4,"Furtividade":2,"Acrobacia":1,"Intimidação":1},hab:[{n:"Rosto na Multidão",tipo:"Passiva",freq:"passiva",d:"Vantagem absoluta em Lábia / Persuasão quando disfarçado de uma facção.",efeitos:[{tipo:"vantagem",em:"pericia",pericia:"Lábia / Persuasão"}]},{n:"Ponto Cego",tipo:"Ativa",freq:"livre",acao:"Ação de Movimento",d:"Ação de Mov.: mistura-se; inimigos o ignoram até você atacar. (NV5: persiste 1 turno após atacar.)",resolve:{tipo:"condicao_propria",cond:"Ponto Cego",turnos:99}}],vet:{n:"Identidade Profunda",tipo:"Passiva",freq:"passiva",d:"O Ponto Cego persiste 1 turno mesmo depois de atacar. E uma terceira identidade blindada resiste a verificações formais da Confederação.",efeitos:[{tipo:"cond_persiste",cond:"Ponto Cego",turnos:1},{tipo:"imunidade",a:"verificação formal da Confederação (identidade blindada)"}]},
  lendaria:{n:"Eu Sou Qualquer Um",tipo:"Passiva",freq:"passiva",d:"Depois de observar alguém por 1 minuto, o Espião assume aquela identidade por inteiro — rosto, voz, maneirismos, assinatura biométrica. Nenhuma verificação da Confederação distingue a cópia do original. Ele deixou de ter um rosto para poder ter todos: Vantagem e +2 em Enganação, sempre.",efeitos:[{tipo:"vantagem",em:"pericia",pericia:"Enganação"},{tipo:"pericia",pericia:"Enganação",valor:2},{tipo:"imunidade",a:"verificação de identidade (biometria, voz, credencial)"}]}},
 "Catador":{pv:6,titulo:"O Rei da Sucata nos Mundos de Fronteira",lore:"Sobrevive nas bordas da galáxia, em mundos de fronteira onde a lei não chega e cada recurso conta. Para o resto do sistema, uma nave abatida é uma tragédia; para o Catador, é um dia de pagamento — tem um talento quase sobrenatural para olhar para uma fonte de alimentação queimada, um processador descartado ou um reator instável e ver o tesouro que fará a nave do grupo voar por mais uma semana. Onde os outros veem lixo, o Catador vê peças de reposição: encontrar itens, consertar equipamentos com recursos limitados e guiar o grupo pelos destroços perigosos da galáxia.",equipamento:"Traje de Bordo Atmosférico (CD +2). Revólver de Íons Pesado (1d8). Bastão de Choque (1d6). Maçarico a laser portátil (ferramenta de corte).",pericias:{"Lábia / Persuasão":3,"Investigação":2,"Sobrevivência":2,"Mecânica":2,"Pilotagem":2,"Armas de Fogo":1},hab:[{n:"Olho para o Ouro",tipo:"Passiva",freq:"livre",d:"Ao investigar: 1d6; com 4–6 (NV5: 3–6) acha item valioso extra.",efeitos:[{tipo:"chance_extra",dado:"1d6",minimo:4,oque:"item valioso",momento:"ao_saquear"}]},{n:"Desmanche Rápido",tipo:"Ativa",freq:"combate",acao:"Ação Principal",d:"1x/combate: arranca placa de inimigo mecânico — 1d8 e −1 CD permanente. (NV5: rouba módulo instalado.)",resolve:{tipo:"desmanche",dado:"1d8",reduzCd:1}}],vet:{n:"Olho Clínico",tipo:"Passiva",freq:"passiva",d:"Olho para o Ouro com 3–6; Desmanche rouba módulos.",efeitos:[{tipo:"chance_extra",dado:"1d6",minimo:3,oque:"item valioso",momento:"ao_saquear"},{tipo:"rouba_modulo"}]},
  lendaria:{n:"Nada se Perde",freq:"longo",d:"Olho para o Ouro passa a encontrar item valioso com 2 a 6 no d6 — quase nada escapa. E 1x/desc. longo, dado tempo e uma pilha de lixo, o Catador improvisa do zero qualquer arma, armadura ou consumível de até 1000 CG, sem pagar nada.",efeitos:[{tipo:"chance_extra",dado:"1d6",minimo:2,oque:"item valioso",momento:"ao_saquear"}],resolve:{tipo:"improvisar",teto:1000}}},
 "Piloto":{pv:6,titulo:"O Coração da Nave",lore:"Enquanto algumas pessoas sentem vertigem ao olhar para o vácuo infinito, o Piloto sente-se em casa. Os seus reflexos estão calibrados para o milissegundo, permitindo-lhe desviar de baterias de mísseis e navegar por campos de asteroides cegos — quando se senta no cockpit de um cargueiro ou de um caça estelar, homem e máquina tornam-se um só organismo. Na terra firme pode parecer ansioso ou deslocado, mas com as mãos num manche é um verdadeiro deus do espaço: a salvação absoluta durante o combate espacial e perseguições veiculares.",equipamento:"Traje de Bordo Atmosférico (CD +2, imune ao vácuo). Revólver de Íons Pesado (1d8) ou Escopeta Sônica (2d6). Chave Inglesa Pesada (1d4). Óculos anti-clarão.",pericias:{"Pilotagem":5,"Mecânica":2,"Lábia / Persuasão":2,"Sobrevivência":2,"Armas de Fogo":1},hab:[{n:"Instinto Evasivo",tipo:"Passiva",freq:"passiva",d:"+2 na CD de qualquer veículo pilotado. (NV5: +4.)",efeitos:[{tipo:"defesa_veiculo",valor:2}]},{n:"Sobrecarga de Propulsores",tipo:"Ativa",freq:"livre",acao:"Reação",d:"Pilotagem com Vantagem para escapar; nave sofre 1d4. (NV5: 1x/combate sem dano.)",resolve:{tipo:"teste",pericia:"Pilotagem",vantagem:true,danoNave:"1d4",rot:"escapar"}}],vet:{n:"Um com a Máquina",tipo:"Passiva",freq:"combate",d:"1x/combate espacial: Sobrecarga sem dano à estrutura.",efeitos:[{tipo:"gratis_por_combate",hab:"Sobrecarga de Propulsores"}]},
  lendaria:{n:"Piloto Fantasma",tipo:"Passiva",freq:"passiva",d:"Homem e máquina deixam de ser duas coisas. O Instinto Evasivo chega ao limite: +6 na Defesa de qualquer veículo pilotado (os +2 da passiva somados a mais +4).",efeitos:[{tipo:"defesa_veiculo",valor:4}]}},
 "Batedor":{pv:8,titulo:"A Vanguarda do Perigo",lore:"O Batedor é a ponta da lança: move-se silenciosamente à frente do grupo principal, lendo rastros no pó vermelho de Marte ou detetando armadilhas a laser nas bases de Júpiter. Combina a intuição de um caçador primitivo com a tecnologia de rastreamento moderna — se o Batedor diz para não pisar ali, é melhor não pisar. Deteta ameaças antecipadamente, dita o ritmo da exploração e neutraliza inimigos isolados antes que o grupo inteiro chegue.",equipamento:"Traje Furtivo de Nanofibra (CD +1, +2 em Furtividade). Sub Metralhadora de Flechetes (2d4, Sangramento). Faca de Plasma (1d4). 1 Granada de Fumaça e kit de primeiros socorros de campo.",pericias:{"Sobrevivência":4,"Armas de Fogo":3,"Investigação":3,"Furtividade":1,"Explosivos":1},hab:[{n:"Sentidos Alertas",tipo:"Passiva",freq:"passiva",d:"Imune a surpresa no 1º turno; +2 Iniciativa.",efeitos:[{tipo:"iniciativa",valor:2},{tipo:"imunidade",a:"ser surpreendido no 1º turno"}]},{n:"Marca do Caçador",tipo:"Ativa",freq:"livre",acao:"Ação Livre",d:"Marca inimigo visível: aliados sabem a posição e ignoram cobertura média. (NV5: +1d4 de dano dos aliados.)",resolve:{tipo:"marcar",cond:"Marcado",turnos:99,ignoraCobertura:1}}],vet:{n:"Predador Paciente",tipo:"Passiva",freq:"passiva",d:"Ataques de aliados contra o marcado: +1d4 de dano.",efeitos:[{tipo:"bonus_marca",dado:"1d4"}]},
  lendaria:{n:"O Território é Meu",tipo:"Passiva",freq:"passiva",d:"A Marca do Caçador deixa de ser um alvo por vez: vale em TODOS os inimigos em cena ao mesmo tempo, e os ataques dos aliados contra marcados passam a causar +1d6 de dano (em vez de +1d4). Onde o Batedor pisa, ninguém se esconde.",efeitos:[{tipo:"marca_em_area"},{tipo:"bonus_marca",dado:"1d6"}]}},
 "Explorador":{pv:6,titulo:"O Navegador das Rotas Logísticas",lore:"O universo não é feito apenas de batalhas e piratas: é feito de complexas rotas de comércio, anomalias estelares e ecossistemas hostis. Mapear o universo exige uma mente capaz de processar sistemas complexos em grande escala, como se a própria galáxia fosse um gigantesco e intrincado sistema de gestão ambiental — o Explorador é o especialista em ler o terreno e transformar desvantagens geográficas em vantagens táticas, garantindo os suprimentos e a sobrevivência a longo prazo da tripulação: guia de terrenos hostis, especialista em biologia alienígena e gestão tática do campo de batalha.",equipamento:"Colete Tático Padrão (CD +2). Rifle de Assalto Híbrido (1d8). Faca de Plasma (1d4). Scanner Ambiental (avisa sobre venenos e radiação) e corda de escalada de nanofibra (15m).",pericias:{"Investigação":4,"Sobrevivência":4,"História / Cultura":3,"Lábia / Persuasão":1},hab:[{n:"Mapeamento Tático",tipo:"Passiva",freq:"passiva",d:"Você e aliados a 10m ignoram terreno difícil.",efeitos:[{tipo:"imunidade",a:"terreno difícil"}]},{n:"Vulnerabilidade Exposta",tipo:"Ativa",freq:"livre",acao:"Ação Principal",d:"Teste de Investigação/Sobrevivência (o melhor dos dois) contra a Defesa do alvo revela a fraqueza; o próximo ataque do grupo contra ele causa +1d6. (NV5: Ação de Mov., dois ataques.)",resolve:{tipo:"marcar",cond:"Exposto",turnos:99,teste:["Investigação","Sobrevivência"]}}],vet:{n:"Cartógrafo do Impossível",tipo:"Passiva",freq:"passiva",d:"Vira Ação de Movimento e vale dois ataques.",efeitos:[{tipo:"acao_de",hab:"Vulnerabilidade Exposta",acao:"Ação de Movimento"},{tipo:"exposto_cargas",valor:2}]},
  lendaria:{n:"Nada é Desconhecido",tipo:"Passiva",freq:"passiva",d:"O Explorador e os aliados a 10 m ficam imunes a dano ambiental — calor, frio, radiação, gás, pressão. E uma Vulnerabilidade Exposta, uma vez revelada, vale contra aquela espécie pelo combate inteiro, não só nos próximos ataques.",efeitos:[{tipo:"imunidade",a:"dano ambiental (calor, frio, radiação, gás, pressão)"},{tipo:"exposto_cargas",valor:99}]}},
 "Cinético":{pv:6,cinetico:true,titulo:"O Construtor de Pontes entre a Mente e a Máquina",lore:"Para dominar a matriz digital e as correntes de dados do universo, o Cinético precisa primeiro confrontar a sua própria \"sombra\" interior. Entende que o inconsciente da galáxia está conectado por fios invisíveis de energia psíquica e código binário — não hackeia apenas computadores, hackeia a força vital das máquinas e dos corpos. Com um movimento da mão, fecha feridas complexas ou entra em ressonância com escudos de energia: especialista em Tecnomancia, manipulador de forças físicas e curandeiro primário do grupo.",equipamento:"Roupas Civis (CD +0). Pistola de Pulso EMP (1d4, Anti-Sintético). Deck Digital de Pulso (interface para scripts). 1 Bateria Fantasma (recupera 1 RAM) e 1 Kit Médico de Batalha.",pericias:{"Tecnomancia":5,"Medicina":3,"Atletismo":2,"Acrobacia":2},hab:[{n:"Bio-feedback",tipo:"Passiva",freq:"passiva",d:"Ao curar um aliado com Script, você recupera 2 PV.",efeitos:[{tipo:"cura_reflexa",valor:2,momento:"ao_curar"}]},{n:"Simbiose Sintética",tipo:"Passiva",freq:"passiva",d:"Limite Cibernético = 2 + INT. Implantes acima de 2 + CON ocupam 1 Slot de RAM cada.",efeitos:[{tipo:"imunidade",a:"limite cibernético por Constituição (usa Int)"}]},{n:"Repulsão Cinética",tipo:"Ativa",freq:"livre",ram:1,d:"Onda de força: adjacentes empurrados 3m; testam Força ou caem.",acao:"Ação Principal",resolve:{tipo:"salvaguarda",atributo:"For",cond:"Caído",turnos:2,area:true,raio:2,empurrao:3}}],vet:{n:"Ressonância de Cromo",tipo:"Passiva",freq:"passiva",d:"+1 na conjuração por cada 3 implantes instalados.",efeitos:[{tipo:"por_implante",cada:3,attr:"conj",valor:1}]},
  lendaria:{n:"Singularidade de Carne e Código",freq:"longo",acao:"Ação Livre",duracao:{base:3},d:"Ação Livre, 1x/desc. longo: a fronteira entre a mente do Cinético e a matriz desaparece por 3 turnos. +5 Slots de RAM e +3 em todas as rolagens de conjuração enquanto durar.",resolve:{tipo:"modo",efeitos:[{tipo:"ram",valor:5},{tipo:"conjuracao",valor:3}]}}},
 "Prospector":{pv:4,titulo:"O Rosto da Tripulação",lore:"Viajar pelas estrelas é incrivelmente caro — combustível, munição, comida, tudo tem um preço. O Prospector é o executivo de terno alinhado no meio de uma taberna poeirenta, o rosto das expedições, sempre em busca de novos patronos, parcerias comerciais e patrocinadores para financiar as viagens do grupo. Quando um acordo de transporte corre mal, é ele que convence a milícia local a não confiscar a nave: o seu sorriso é a sua armadura, e a sua eloquência é a sua arma — negociador absoluto, líder em cenas sociais e gestor dos lucros da equipa.",equipamento:"Roupas Civis de Alto Luxo (CD +0). Pistola Laser Compacta (1d6). Contratos em branco, caneta de assinatura digital e um Datapad corporativo. Recebe 100 Créditos adicionais no início.",pericias:{"Lábia / Persuasão":5,"Intuição":4,"Tecnomancia":3},hab:[{n:"Contrato Lucrativo",tipo:"Passiva",freq:"passiva",d:"Recompensas de missão +20% (NV5: +30%).",efeitos:[{tipo:"bonus_recompensa",pct:20,momento:"ao_saquear"}]},{n:"\u201cEspere, podemos resolver isto\u201d",tipo:"Ativa",freq:"combate",d:"1x/combate: inimigo que o entenda hesita e perde a Ação Principal.",acao:"Ação de Movimento",resolve:{tipo:"salvaguarda",atributo:"Sab",cond:"Hesitante",turnos:1}}],vet:{n:"Cláusula de Contingência",freq:"sessao",d:"Recompensas sobem para +30%. E 1x/sessão: contato corporativo — informação, porta, embarque.",efeitos:[{tipo:"bonus_recompensa",pct:10,momento:"ao_saquear"}],resolve:{tipo:"consulta",pergunta:"O que o contato precisa resolver?"}},
  lendaria:{n:"Dono do Contrato",tipo:"Passiva",freq:"passiva",d:"O Prospector deixou de negociar contratos e passou a escrevê-los: as recompensas de missão da tripulação sobem para +50% no total (os +30% da Veterana somados a mais +20%). E 1x/sessão ele fecha um negócio impossível: uma compra na loja sai pela metade do preço.",efeitos:[{tipo:"bonus_recompensa",pct:20,momento:"ao_saquear"},{tipo:"desconto_loja",pct:50}]}},
 "Pirata":{pv:10,titulo:"O Terror do Vácuo",lore:"Onde a Confederação vê leis, o Pirata vê sugestões. É um lobo do espaço, especializado em invasões de naves (boarding) e combate em corredores estreitos, que luta sujo, aproveitando-se do medo e do caos para dominar os inimigos — não precisa da melhor arma, só precisa de ser o mais assustador na sala para que os adversários cometam erros: combate brutal a curta distância, resistência colossal e controlo de multidões pelo medo.",equipamento:"Colete Tático Padrão (CD +2). Escopeta Sônica (2d6). Bastão de Choque (1d6) ou Faca de Plasma (1d4). Um arpéu magnético de abordagem e 1 Granada de Fumaça.",pericias:{"Armas de Fogo":3,"Armas Brancas":3,"Intimidação":3,"Sobrevivência":2,"Pilotagem":1},hab:[{n:"Brutalidade de Abordagem",tipo:"Passiva",freq:"passiva",d:"Ignora espaços confinados; +1 de dano dentro de naves.",efeitos:[{tipo:"dano",valor:1,quando:"em_nave",momento:"ao_atacar"},{tipo:"imunidade",a:"penalidade de espaços confinados"}]},{n:"Grito de Saqueador",tipo:"Ativa",freq:"livre",acao:"Ação Principal",d:"Inimigos a 5m testam Sabedoria (NV5: Desvantagem) ou Amedrontados 2 turnos.",resolve:{tipo:"salvaguarda",atributo:"Sab",cond:"Amedrontado",turnos:2,area:true,raio:5}}],vet:{n:"Terror Nominal",tipo:"Passiva",freq:"passiva",d:"O Grito de Saqueador impõe Desvantagem no teste de Sabedoria, e alvos Amedrontados sofrem +2 de dano dos seus ataques.",efeitos:[{tipo:"save_desvantagem",hab:"Grito de Saqueador"},{tipo:"dano",valor:2,quando:"alvo_amedrontado",momento:"ao_atacar"}]},
  lendaria:{n:"Bandeira Negra",freq:"longo",acao:"Ação Principal",d:"Ação Principal, 1x/desc. longo: o Pirata diz o próprio nome e o setor inteiro lembra do que ele fez. Inimigos num raio de 10 m testam Sabedoria ou ficam Amedrontados por 4 turnos.",resolve:{tipo:"salvaguarda",atributo:"Sab",cond:"Amedrontado",turnos:4,area:true,raio:10}}},
};
...
export const IMPLANTES = [
 ...
 {n:"Placas Subdérmicas de Titânio",p:1100,e:"+1 na CD, cumulativo com armadura",g:"Torso",efeitos:[{tipo:"defesa",valor:1}]},
 {n:"Coração Sintético de Duplo Fluxo",p:2500,e:"+5 PV máximos, +2 contra venenos",g:"Torso",efeitos:[{tipo:"pv_max",valor:5},{tipo:"resistencia",a:"Envenenado"}]},
 {n:"Filtro Pulmonar Universal",p:750,e:"Imune a gases venenosos e ambientais",g:"Torso"},
 {n:"Reator de Adrenalina",p:3000,e:"1x/dia: Ação Principal extra",g:"Torso",ativa:{freq:"dia",d:"Ação Livre: 1 Ação Principal extra neste turno.",efeitos:[{tipo:"recurso",n:"Ação Principal extra",freq:"longo"}]}},
 ...
 {n:"Braço Mecânico Hidráulico",p:850,e:"+2 dano corpo a corpo, Vantagem em Força",g:"Membros",efeitos:[{tipo:"dano",valor:2,contra:"branca",momento:"ao_atacar"},{tipo:"vantagem",em:"pericia",pericia:"Atletismo"}]},
 {n:"Estabilizador de Pulso",p:500,e:"Anula penalidades de armas pesadas",g:"Membros",efeitos:[{tipo:"acerto",valor:2,contra:"fogo",momento:"ao_atacar"}]},
 {n:"Lâmina Oculta Retrátil (Mantis)",p:1000,e:"Ataque próprio (1d8, branca, Oculta); dobra o dano em ataques Furtivos",g:"Membros",
  ataque:{dano:"1d8",tipo:"branca",per:"Armas Brancas",attr:"For",kw:"Oculta"},
...
export const SCRIPTS = [
 ...
 {n:"Choque Estático",c:0,a:"Ação Principal",dmg:"1d6",resolve:{tipo:"ataque",dado:"1d6",tipoDano:"elétrico"},d:"Arco elétrico. 1d6 de dano.",lore:"Focando a bioeletricidade através das pontas dos dedos ou do seu deck, dispara um arco elétrico azulado. Causa 1d6 de dano e cheira a ozônio."},
 ...
 {n:"Rollback Celular",c:1,a:"Ação Principal",dmg:"1d8+Int",resolve:{tipo:"cura",dado:"1d8",attr:"Int"},d:"Cura 1d8 + Int de um aliado tocado.",lore:"Um script médico. Nanites ou a própria matriz de luz da Tecnomancia forçam as células de um aliado tocado a carregarem o seu \"save state\" anterior. Cura 1d8 + Inteligência de forma espetacular, fechando cortes num piscar de olhos."},
 {n:"Firewall Ativo",c:1,a:"Reação",dmg:"1d10+Int",resolve:{tipo:"pvtemp",dado:"1d10",attr:"Int",proprio:true},d:"Barreira hardlight absorve 1d10 + Int de um impacto.",lore:"Quando um tiro está prestes a acertar, o Tecnomante ergue a mão. Uma barreira hexagonal de *hardlight* (luz dura) cristaliza-se no ar, absorvendo 1d10 + Inteligência de dano daquele impacto antes de estilhaçar como vidro. ## **🟡 INJEÇÕES MALICIOSAS (Nível 2)** *Requisito: Tecnomancia +4 até +6. Códigos agressivos desenhados para a guerra. Eles ignoram protocolos de segurança e afetam diretamente a biologia e o equipamento do inimigo.*"},
 ...
 {n:"Curto-Circuito em Armadura",c:2,a:"Ação Principal",dmg:"1d4",resolve:{tipo:"ataque",dado:"1d4"},d:"−3 CD do alvo por 2 turnos e 1d4 de queimadura.",lore:"Frita os servomotores de um exoesqueleto ou armadura pesada. O traje trava nas juntas, a CD do alvo cai em -3 por 2 turnos e o calor das placas causa 1d4 de queimadura nas costas do inimigo."},
 {n:"Hackear Implante Motor",c:2,a:"Ação Principal",resolve:{tipo:"ataque",cond:"Motor Travado",turnos:3},d:"Deslocamento pela metade, sem Esquiva, 3 turnos.",lore:"Toma o controlo parcial das pernas cibernéticas de um inimigo. Ele passa a andar arrastando-se, com o deslocamento reduzido a metade, e não pode Esquivar por 3 turnos."},
 {n:"Cegueira Cibernética",c:2,a:"Ação Principal",resolve:{tipo:"ataque",cond:"Cego",turnos:2},d:"Cego 2 turnos, ataques com Desvantagem.",lore:"Desliga os implantes óticos do alvo, mergulhando-o na escuridão digital. Cego por 2 turnos, rola todos os ataques com Desvantagem."},
 {n:"Drenar Escudos",c:2,a:"Ação Principal",resolve:{tipo:"drenar_escudos"},d:"Suga escudos; metade vira Vida Temporária sua.",lore:"Como um vampiro digital, estende fios de energia pura que sugam os escudos do alvo. Metade do valor drenado converte-se em Vida Temporária para o próprio Tecnomante."},
 {n:"Sobrecarga de Sistema",c:2,a:"Ação Principal",dmg:"2d6",resolve:{tipo:"ataque",dado:"2d6",area:true,raio:2,tipoDano:"elétrico"},d:"Área 3×3m: 2d6 elétrico em cadeia.",lore:"Frita a rede elétrica local. Lâmpadas estouram e painéis explodem em faíscas. Inimigos numa área de 3x3m sofrem 2d6 de dano elétrico em cadeia."},
 ...
 {n:"Reparo Estrutural em Massa",c:4,a:"Ação Principal",dmg:"4d10",resolve:{tipo:"reparo_nave",dado:"4d10"},d:"Nanites restauram 4d10 do casco da sua nave."},
...
export const ARMADURAS = [
 ...
 {n:"Armadura de Engenharia Conjupitera",preco:500,t:"pesada",cd:4,e:"−2 Furtividade; +2 Mecânica",efeitos:[{tipo:"pericia",pericia:"Furtividade",valor:-2},{tipo:"pericia",pericia:"Mecânica",valor:2}],desc:"Um traje selado, atarracado e incrivelmente pesado, forjado nas fornalhas de Júpiter. Os braços têm maçaricos, chaves de calibração e fios de diagnóstico integrados nas manoplas. Um Mecânico a usar isto é um autêntico tanque de suporte."},
 {n:"Armadura Pesada Marciana",preco:650,t:"pesada",cd:6,e:"−4 Furtividade; exige For +2",efeitos:[{tipo:"pericia",pericia:"Furtividade",valor:-4}],desc:"O orgulho do Sindicato de Deimos. Placas angulares de liga de titânio vermelho-ferrugem. Transformam um humanoide num colosso de metal impenetrável. Um esquadrão a marchar com estas armaduras faz o chão da nave tremer."},
 {n:"Blindagem Dispersora de Impacto",preco:900,t:"pesada",cd:3,e:"Nega dano crítico; −3 Furtividade",desc:"Um sanduíche de placas cerâmicas soltas sobre um gel viscoelástico, nascido de um desastre de mineração em que a rigidez total matou mais gente do que os escombros. Não segura o golpe — dispersa a energia de um impacto que deveria ser certeiro por toda a placa antes que ela concentre num só ponto, transformando o que seria fatal em só mais um arranhão fundo. Cara, rígida e pesada; atrapalha qualquer manobra sutil.",efeitos:[{tipo:"sem_critico",momento:"ao_sofrer"},{tipo:"pericia",pericia:"Furtividade",valor:-3}]},
...
export const CONSUMIVEIS = [
  ...
  { n: "Granada de Fragmentação", p: 100, ic: "💥", efeito: "condicao", cond: "Sangrando", turnos: 3, area: true, raio: 2, dano: "3d6", cd: 14, pericia: "Acrobacia", acao: "Ação Principal",
    d: "Estilhaços em área 3×3m: 3d6 de dano e Sangrando por 3 turnos (Acrobacia CD 14 reduz à metade e evita o sangramento)." },
  { n: "Granada de Fumaça", p: 35, ic: "🌫", efeito: "nenhum", acao: "Ação Principal",
    d: "Cria cobertura visual em área e facilita fugas." },
  { n: "Granada de Luz", p: 40, ic: "💡", efeito: "condicao", cond: "Cego", turnos: 2, area: true, raio: 2, cd: 13, atributo: "Con", acao: "Ação Principal",
...
export const TIPOS_PENTE = {
  ...
  emp:         { n: "EMP",          ic: "⚡", cor: "#7ad0f0", p: 90,
                 ...
                 bonusSint: "2d6", cond: null, tipoDano: "elétrico" },
  ...
  incendiaria: { n: "Incendiária",  ic: "🔥", cor: "#f0a860", p: 80,
                 d: "Carga de fósforo. Ao acertar, o alvo pega fogo: condição Em chamas por 3 turnos (1d6/turno).",
                 cond: "Em chamas", turnos: 3, tipoDano: "térmico" },
};
