...
export const RACAS = [
 ...
 },
 {
  ...
  "lendaria": {
   ...
   "resolve": { "tipo": "salvaguarda", "atributo": "Con", "dado": "4d8", "cond": "Paralisado", "turnos": 1, "area": true }
  }
 },
 {
  "nome": "Proturno",
...
export const SCRIPTS = [
 ...
 {n:"Choque Estático",c:0,a:"Ação Principal",dmg:"1d6",resolve:{tipo:"ataque",dado:"1d6"},d:"Arco elétrico. 1d6 de dano.",lore:"Focando a bioeletricidade através das pontas dos dedos ou do seu deck, dispara um arco elétrico azulado. Causa 1d6 de dano e cheira a ozônio."},
 ...
 {n:"Sobrecarga de Sistema",c:2,a:"Ação Principal",dmg:"2d6",resolve:{tipo:"ataque",dado:"2d6",area:true},d:"Área 3×3m: 2d6 elétrico em cadeia.",lore:"Frita a rede elétrica local. Lâmpadas estouram e painéis explodem em faíscas. Inimigos numa área de 3x3m sofrem 2d6 de dano elétrico em cadeia."},
...
export const CONSUMIVEIS = [
  ...
  { n: "Granada Paralisante", p: 130, ic: "🧊", efeito: "condicao", cond: "Paralisado", turnos: 1, area: true, cd: 13, atributo: "Con", acao: "Ação Principal",
    d: "Descarga neural em área 3×3m. Cada alvo testa Constituição (CD 13) ou fica Paralisado por 1 turno." },
  { n: "Granada Incendiária", p: 95, ic: "🔥", efeito: "condicao", cond: "Em chamas", turnos: 3, area: true, dano: "2d6", cd: 14, pericia: "Acrobacia", acao: "Ação Principal",
    d: "Fósforo em área 3×3m: 2d6 imediatos e a condição Em chamas por 3 turnos em quem falhar em Acrobacia (CD 14)." },
  { n: "Granada de Fragmentação", p: 100, ic: "💥", efeito: "condicao", cond: "Sangrando", turnos: 3, area: true, dano: "3d6", cd: 14, pericia: "Acrobacia", acao: "Ação Principal",
  ...
  { n: "Granada de Luz", p: 40, ic: "💡", efeito: "condicao", cond: "Cego", turnos: 2, area: true, cd: 13, atributo: "Con", acao: "Ação Principal",
