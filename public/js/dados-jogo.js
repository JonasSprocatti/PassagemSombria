...
export const CLASSES = {
 ...
 "Espião":{pv:4,titulo:"O Fantasma de Mil Rostos",lore:"A guerra não se vence apenas com armas pesadas, mas com a informação certa sussurrada no ouvido certo. O Espião é o mestre da engenharia social e da infiltração — não se esconde nas sombras como os Assassinos, esconde-se à vista de todos, vestindo a farda do inimigo, forjando credenciais e imitando sotaques. Consegue entrar num cofre de segurança máxima de Deimos apenas com uma prancheta na mão e a atitude inabalável de que \"pertence àquele lugar\": infiltração social, extração de informações sem disparar alarmes e manipulação de NPCs.",equipamento:"Roupas Civis (CD +0). Pistola Laser Compacta (1d6). Faca de Plasma (1d4, Oculta). Um kit com 2 Identidades Falsas credenciadas da Confederação e credenciais corporativas.",pericias:{"Enganação":4,"Lábia / Persuasão":4,"Furtividade":2,"Acrobacia":1,"Intimidação":1},hab:[{n:"Rosto na Multidão",tipo:"Passiva",freq:"passiva",d:"Vantagem absoluta em Lábia / Persuasão quando disfarçado de uma facção.",efeitos:[{tipo:"vantagem",em:"pericia",pericia:"Lábia / Persuasão"}]},{n:"Ponto Cego",tipo:"Ativa",freq:"livre",d:"Ação de Mov.: mistura-se; inimigos o ignoram até você atacar. (NV5: persiste 1 turno após atacar.)"}],vet:{n:"Identidade Profunda",freq:"passiva",d:"Terceira identidade blindada — resiste a verificações formais da Confederação."},
